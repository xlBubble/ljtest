...
APP_ID = os.environ.get('APP_ID') or 'work-manage'
APP_TOKEN = os.environ.get('APP_TOKEN') or 'b777ff74-8b50-4324-9fc6-8e75236b7bf1'
# 平台host
BK_PAAS_HOST = os.environ.get('BK_PAAS_HOST') or 'http://http://paas.bking.com'
# 数据库初始化 超级用户列表
